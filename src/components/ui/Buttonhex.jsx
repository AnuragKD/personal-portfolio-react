export default function Buttonhex({
    ...
    return (
        <button
            ...
            {...props}
        >
            <svg className={`w-16 md:w-20 h-auto transition-all ${children ? " text-white drop-shadow-[0_0_1px_rgba(0,0,0,0.1)] hover:drop-shadow-[0_0_6px_rgba(84,129,79,0.4)]" :"text-[#fcfcfc]"}`} 
